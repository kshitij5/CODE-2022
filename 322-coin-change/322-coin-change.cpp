class Solution {
public:
    // using combination sum  problem
    // gives tle
//     void comb(vector<int>& coins, int amount, int idx, vector<int>& res, int& ans) {
...
//             comb(coins, amount-coins[idx], idx, res, ans);
//             res.pop_back();
//         }
        
//         comb(coins, amount, idx+1, res, ans);
//         return;
//     }
//     int coinChange(vector<int>& coins, int amount) {
//         vector<int> res;
//         int ans = INT_MAX;
//         comb(coins, amount, 0, res, ans);
